    ...
    return (
      <div className="min-h-screen bg-surface-50 flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-brand-900">Inspection Submitted</h2>
          <p className="text-surface-500 text-sm">SWPPP inspection has been recorded and corrective actions assigned.</p>
        </motion.div>
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between max-w-5xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-surface-500">Storm Water Pollution Prevention Plan</p>
            </div>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="bg-white p-6 rounded-3xl border border-surface-100 shadow-soft">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-surface-500">{stats.completed} of {stats.total} items inspected</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-surface-100 shadow-soft">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="text-xs font-bold text-surface-400 uppercase mb-1 block">
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <div>
              <label className="text-xs font-bold text-surface-400 uppercase mb-1 block">Precipitation Last 24h</label>
              <select
            ...
            <div>
              <label className="text-xs font-bold text-surface-400 uppercase mb-1 block">Precipitation Last 72h</label>
              <select
        ...
        <div className="space-y-4">
          {SWPPP_CATEGORIES.map(category => (
            <div key={category.id} className="bg-white rounded-3xl border border-surface-100 shadow-soft overflow-hidden">
              <button
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <h3 className="font-bold text-surface-900">{category.name}</h3>
                        ...
                        <div key={item.id} className="p-4 bg-surface-50 rounded-2xl">
                          <div className="flex items-start justify-between gap-4 mb-3">
                            <div className="flex items-start gap-2">
                              {item.required && (
                                <span className="px-1.5 py-0.5 bg-red-100 text-red-600 text-[10px] font-bold uppercase rounded">Req</span>
                              )}
        ...
        <div className="bg-white rounded-3xl border border-surface-100 shadow-soft p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-surface-900">Corrective Actions</h3>
                <p className="text-sm text-surface-500">{correctiveActions.length} actions assigned</p>
              </div>
            </div>
            <button
          ...
          {showAddAction && (
            <motion.div
              ...
              className="p-4 bg-surface-50 rounded-2xl mb-4 space-y-3"
            >
              <input
                type="text"
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-brand-600 text-white rounded-xl font-bold text-sm"
                >
                  Add
                </button>
                <button
                  onClick={() => setShowAddAction(false)}
                  className="px-4 py-2 bg-surface-200 text-surface-600 rounded-xl font-bold text-sm"
                >
                  Cancel
                </button>
              </div>
          ...
          {correctiveActions.length > 0 ? (
            <div className="space-y-3">
              {correctiveActions.map((action, i) => (
                <div key={action.id} className="p-4 bg-surface-50 rounded-2xl flex items-start justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm font-bold text-surface-900">{action.issue}</span>
                    </div>
                    <p className="text-sm text-surface-600">{action.action}</p>
            ...
            <p className="text-center text-surface-400 py-8">No corrective actions added yet</p>
          )}
        </div>
      </main>
    </div>
