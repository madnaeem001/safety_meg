    ...
    <div className="ai-purple-theme min-h-screen bg-surface-base pb-20">
      ...
      <div className="pt-20 px-4 md:px-6 max-w-[1920px] mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mb-6 grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            { label: 'AI Reports Analyzed', value: incidentStats?.total ?? 1247, icon: Brain, color: 'text-primary bg-primary/10' },
            { label: 'Patterns Detected', value: incidentStats?.distinctTypes ?? 23, icon: Activity, color: 'text-accent bg-accent/10' },
